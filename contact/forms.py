...
class StudentSelect(forms.ModelForm):
    ...
    def __init__(self, team, *args, **kwargs):
        ...
        student_choices = Members.objects.filter(team_id=team).order_by('student_name').values_list('id', 'student_name')
...
class ContactForm(ModelForm):
    class Meta:
        ...
        labels= dict(contact_state="State", contact_first="First Name", contact_last="Last Name", contact_phone="Phone",
                     contact_email="Email")
    ...
    def clean(self):
        ...
        cleaned_data['contact_first'] = cleaned_data['contact_name'].title()
